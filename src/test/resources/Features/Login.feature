...
Scenario: Register an Accoun test case
	When User click  on MyAccount
	And User click on Register option
	And User fill the Registration form with the below information
	|firstName|lastName|email|telephone|password|confirmPasswor|subscribe|
	|Alex|Sokolova|alex169@gmail.com|101998744|test|test|no|
	And User accept the privacy and policy
	And User click on Continue button 
	Then User should be regestered in Retail Website
